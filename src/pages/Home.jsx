...
const barOptions = {
  responsive: true,
  plugins: { legend: { position: 'top' }, title: { display: true, text: 'Aylıq Tapşırıq Statistikası' } }
};
const barData = {
...
const data = [
  { id: '#951', title: 'Hotel management system', start_date: '15 Nov, 2025', due_date: '15 Dec, 2025', status: 'IN_PROGRESS', description: 'Booking & room management.', priority: 'HIGH', assignee: 'User 1', estimated_hours: 120 },
  { id: '#547', title: 'Product development', start_date: '14 Nov, 2025', due_date: '14 Dec, 2025', status: 'TODO', description: 'New product v2.', priority: 'MEDIUM', assignee: 'User 2', estimated_hours: 80 },
  { id: '#658', title: 'Python upgrade', start_date: '13 Nov, 2025', due_date: '13 Dec, 2025', status: 'DONE', description: 'Upgrade Python version to 3.12.', priority: 'LOW', assignee: 'User 3', estimated_hours: 40 }
];
...
function Home() {
  ...
  return (
    <div>
      ...
      <div className={`p-6 rounded-lg shadow-md transition duration-500 ${isDark ? 'bg-[#1B232D]' : 'bg-white'}`}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className={`p-4 rounded-lg shadow ${isDark ? 'bg-[#131920]' : ''}`}><Bar options={barOptions} data={barData} /></div>
          <div className={`p-4 rounded-lg shadow ${isDark ? 'bg-[#131920]' : ''} max-w-[400px] mx-auto`}><Doughnut data={doughnutData} /></div>
        </div>

        <div>
          <h3 className="text-lg font-semibold mb-4">Son Tapşırıqlar</h3>
