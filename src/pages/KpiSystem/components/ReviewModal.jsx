...
    : isTMEvaluationPending || isCurrentUserTMEvaluator 
    ? `Yuxarı İdarəetmə Dəyərləndirməsi (1-100) - ${assigneesFullName}`
    : `Üst Rəhbər Dəyərləndirməsi (1-100) - ${assigneesFullName}`;
...
  };
  
  const okText = isOwnEvaluation 
    ? "Öz Dəyərləndirməni Qeyd Et" 
    : isTMEvaluationPending || isCurrentUserTMEvaluator 
    ? "Yuxarı İdarəetmə Dəyərləndirməsini Qeyd Et"
    : "Üst Rəhbər Dəyərləndirməsini Qeyd Et";

  const evaluationRoleType = isCurrentUserTMEvaluator ? "Top Management" : "Üst Rəhbər";
...
            score={starRating} 
            maxScore={maxScore} 
            type={isOwnEvaluation ? "self" : isCurrentUserTMEvaluator ? "top_management" : "superior"} 
            size="large" 
          />
        </div>
        <div>
