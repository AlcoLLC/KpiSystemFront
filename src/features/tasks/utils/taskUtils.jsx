...
export const generateDetailsItems = (record) =>
  !record
    ? []
    : [
        ...
        { key: 'status', label: 'Status', value: record.status_display || '-' },
        {
          ...
          value: record.start_date ? dayjs(record.start_date).format('DD MMMM YYYY') : '-'
        },
        {
          key: 'due_date',
          label: 'Bitmə tarixi',
          value: record.due_date ? dayjs(record.due_date).format('DD MMMM YYYY') : '-'
        },
        {
          key: 'created_at',
